...
// Method Definition Index: 11738
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void Queue_1_TrimExcess_mFAB8181328ED344FDC5221A7A89F59C79B319037_gshared (Queue_1_tCB129414E19C8694C655AF7056458F9CBDEFE047* __this, const RuntimeMethod* method) 
{
	int32_t V_0 = 0;
	{
		MessageDataU5BU5D_t7270B876CF29EEC3260CF2FAEE4F155AD6AE7956* L_0 = __this->____array;
		NullCheck(L_0);
		V_0 = il2cpp_codegen_cast_double_to_int<int32_t>(((double)il2cpp_codegen_multiply(((double)((int32_t)(((RuntimeArray*)L_0)->max_length))), (0.90000000000000002))));
		int32_t L_1 = __this->____size;
		int32_t L_2 = V_0;
	...
	{
		int32_t L_3 = __this->____size;
		Queue_1_SetCapacity_mF4DDF27C1B21EE76BE700459092DDCF2FB70618A(__this, L_3, il2cpp_rgctx_method(method->klass->rgctx_data, 7));
	}
